...
export default function DashboardShimmer() {
  return (
    ...
    >
      ...
      <rect x="50" y="207" rx="4" ry="4" width="100" height="80" />
      <rect x="160" y="207" rx="4" ry="4" width="100" height="80" />
      <rect x="50" y="317" rx="4" ry="4" width="100" height="80" />
      <rect x="160" y="317" rx="4" ry="4" width="100" height="80" />
      <rect x="50" y="417" rx="4" ry="4" width="212" height="21" />
